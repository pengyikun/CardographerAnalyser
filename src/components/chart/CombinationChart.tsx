...
export const CombinationChart: FC<CombinationChartProps> = (props) => {
            ...
            <ResponsiveContainer width="95%" height={200}>
                ...
                >
                    ...
                    <XAxis dataKey="snapshotId"
                           style={{fontSize: '8px'}}/>
                    <YAxis dataKey="combinationCount" width={20} style={{fontSize: '8px'}}/>
                    <Tooltip/>
                    ...
                    <Area name="Combination count" type="monotone" dataKey="combinationCount"
